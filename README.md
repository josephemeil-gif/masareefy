...
**Live app:** open `index.html` (or `expense-tracker.html`) in any browser. No installation, no server, no account online — all data stays on your device (browser local storage).
